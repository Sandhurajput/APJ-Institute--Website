...
export default function FacilitiesPage() {
  ...
  const features = [
    ...
    { title: "Paramedical Courses", desc: "Comprehensive programs for aspiring healthcare professionals.", icon: <BookOpen size={24}/>, img: "/assets/lab_setup.jpg" },
  ...
  return (
    <div ref={containerRef} className="bg-[#020617] min-h-screen text-slate-200 overflow-hidden font-sans selection:bg-cyan-500/30">
      ...
      <section className="relative min-h-screen flex flex-col pt-10 overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 w-full flex-grow flex flex-col items-center justify-center text-center pb-12">
          ...
          <motion.p initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, delay: 0.4, ease: [0.22, 1, 0.36, 1] }}
            className="text-lg md:text-xl text-blue-100/70 mb-10 leading-relaxed font-medium max-w-3xl">
          ...
          >
            <MagneticButton 
              ...
              className="relative group overflow-hidden px-8 py-4 rounded-full bg-white text-[#020617] font-bold text-base flex items-center gap-3 shadow-[0_0_50px_rgba(255,255,255,0.15)]"
            >
        ...
        <motion.div initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, delay: 0.8 }} className="relative z-30 w-full px-4 pb-16 md:pb-24 lg:pb-32">
          <div className="mx-auto max-w-7xl">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 p-4 rounded-3xl md:rounded-[2.5rem] bg-white/5 backdrop-blur-3xl border border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.3)] md:shadow-[0_40px_100px_rgba(0,0,0,0.5)]">
              {[ { v: "100", s: "%", l: "Practical Training" }, { v: "15", s: "+", l: "Expert Faculty" }, { v: "5", s: "+", l: "Advanced Labs" }, { v: "24", s: "/7", l: "Boys Hostel" } ].map((stat, i) => (
                <div key={i} className="text-center p-4 md:p-6 relative group overflow-hidden rounded-2xl md:rounded-3xl">
            ...
            {bentoItems.map((item, i) => (
              ...
              >
                ...
                <div className="absolute inset-0 p-6 lg:p-8 flex flex-col justify-end z-10">
                  <motion.div className="w-12 h-12 lg:w-16 lg:h-16 rounded-2xl bg-white/10 backdrop-blur-xl border border-white/20 flex items-center justify-center text-cyan-300 mb-4 lg:mb-6 group-hover:-translate-y-2 group-hover:bg-cyan-400 group-hover:text-[#020617] group-hover:shadow-[0_0_40px_rgba(34,211,238,0.6)] transition-all duration-500">
                    {item.icon}
                  </motion.div>
      ...
      ════════════════════════════════════════════ */}
      <section className="py-16 md:py-32 relative overflow-hidden bg-white text-slate-900 rounded-3xl md:rounded-[4rem] mx-4 md:mx-6 lg:mx-8 shadow-[0_0_100px_rgba(0,0,0,1)]">
        ...
        <div className="mx-auto max-w-7xl px-4 lg:px-8 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 md:gap-20 items-center">
            ...
            {/* Overlapping Collage */}
            <div className="relative h-[400px] sm:h-[500px] md:h-[600px] w-full mt-10 lg:mt-0 block">
              ...
              >
                ...
                <p className="text-slate-700 text-sm font-bold italic">"Excellent practical training facilities for students."</p>
              </motion.div>
            </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, i) => (
              <motion.div key={i} initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-50px" }} transition={{ duration: 0.8, delay: i * 0.1 }}
                className="group relative p-10 rounded-[3rem] bg-[#020617] border border-white/5 hover:border-cyan-500/30 transition-all duration-500 overflow-hidden"
              >
                {/* Background Image */}
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-[#020617] via-[#020617]/60 to-[#020617]/10 z-0 group-hover:via-[#020617]/40 transition-all duration-700"></div>
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        >
          <div className="relative overflow-hidden rounded-[3rem] text-center p-10 md:p-16 shadow-[0_0_80px_rgba(30,58,95,0.6)] border border-white/20 group">
            ...
            <div className="relative z-10 max-w-3xl mx-auto flex flex-col items-center">
              ...
              <div className="flex flex-col sm:flex-row justify-center items-center gap-6 w-full">
                <MagneticButton className="relative overflow-hidden w-full sm:w-auto px-10 py-4 rounded-full bg-white text-[#020617] font-black text-lg shadow-[0_0_50px_rgba(255,255,255,0.3)] flex items-center justify-center gap-3 group/btn">
                  <span className="relative z-10 flex items-center gap-2">Apply Online <ArrowRight size={20} className="group-hover/btn:translate-x-2 transition-transform" /></span>
                ...
                <MagneticButton className="w-full sm:w-auto px-10 py-4 rounded-full border border-white/50 text-white font-black text-lg hover:bg-white/20 transition-colors backdrop-blur-md">
                  Contact Us
                </MagneticButton>
              </div>
            </div>
